...
class ReservationController:
    def __init__(self):
        ...
        # Instantiate the repository objects
    ...
    # Define the view_reservations() function
    ...
    # Define the process_payment() function
    ...
    # Define the make_reservation() function
    ...
    # Define the function to search flights
    ...
    # Call the _find_cheapest_route() function
    ...
    # Create the _handle_user_choice() function

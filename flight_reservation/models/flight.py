...
class Flight:
    ...
    def book_seats(self, num_seats):
        # Attempt to book a specified number of seats
    ...
    # Return a string representation of the flight details
    def __repr__(self):
    ...
    # Implement the get_ticket_price() function 

...
df = pd.read_csv('flight_reservation/dataset/airlines.csv')  
...
df = pd.read_csv('flight_reservation/dataset/airports.csv')
...
# Load the dataframe from the CSV file
flights_df = pd.read_csv('flight_reservation/dataset/flights.csv')
